...
review_1 = book_1.reviews.create(title: "Good book", rating: 4, review_text: "My third favorite", created_at: 1.year.ago)
review_2 = book_1.reviews.create(title: "Magic Rocks", rating: 5, review_text: "I wish I was a wizard", created_at: 2.months.ago)
review_3 = book_1.reviews.create(title: "Team Hermoine", rating: 4, review_text: "Screw you Ron", created_at: 2.months.ago)
review_4 = book_2.reviews.create(title: "So-so", rating: 3, review_text: "Predictable", created_at: 3.months.ago)
review_5 = book_3.reviews.create(title: "Meh", rating: 4, review_text: "Good, but why read when you can watch the movie", created_at: 2.days.ago)
review_6 = book_4.reviews.create(title: "Exciting", rating: 4, review_text: "Another great by the King", created_at: 3.months.ago)
review_7 = book_4.reviews.create(title: "Too scary", rating: 1, review_text: "Some say I'm a coward, but it's just not for me.", created_at: 2.months.ago)
review_8 = book_5.reviews.create(title: "As Expected", rating: 5, review_text: "Love Ruby", created_at: 2.days.ago)
review_9 = book_5.reviews.create(title: "Boring", rating: 1, review_text: "C++ is better", created_at: 3.days.ago)
review_10 = book_6.reviews.create(title: "Team Voldemort", rating: 1, review_text: "The bad guys won", created_at: 2.years.ago)
review_11 = book_7.reviews.create(title: "What the?", rating: 1, review_text: "The was little to no magic.", created_at: 2.months.ago)
review_12 = book_9.reviews.create(title: "Umm...", rating: 3, review_text: "Think I read this for class once. There's a horse maybe?", created_at: 2.months.ago)
...
review_14 = book_11.reviews.create(title: "My fave", rating: 5, review_text: "It's good", created_at: 2.months.ago)
review_15 = book_11.reviews.create(title: "Just read it again", rating: 5, review_text: "Good dark humor for a nihilist", created_at: 10.months.ago)
review_16 = book_13.reviews.create(title: "Lame", rating: 2, review_text: "No mention of Chewie at all", created_at: 2.years.ago)
review_17 = book_14.reviews.create(title: "Whoops", rating: 1, review_text: "Thought it was gonna be a self-help book. Couldv'e used the help.", created_at: 1.months.ago)
review_18 = book_14.reviews.create(title: "Stay away", rating: 1, review_text: "Dry AF", created_at: 8.months.ago)
review_19 = book_14.reviews.create(title: "Don't get it...", rating: 5, review_text: "but good?", created_at: 5.months.ago)
